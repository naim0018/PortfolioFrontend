      ...
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-[#f9fafb] text-[#1f2937] shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="flex justify-end text-xs text-[#4b5563] mt-2">
        ...
        <div className="flex items-center pt-4 space-x-1">
          <div className="flex-1 h-px sm:w-16 bg-[#d1d5db]"></div>
          <p className="px-3 text-sm text-[#4b5563]">
            Login with social accounts
          </p>
          <div className="flex-1 h-px sm:w-16 bg-[#d1d5db]"></div>
        </div>
        <div className="flex justify-center space-x-4">
          <button aria-label="Log in with Google" className="p-3 rounded-sm bg-[#e5e7eb] hover:bg-[#d1d5db] transition-colors">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current text-[#1f2937]"
            >
              <path d="M16.318 13.714v5.484h9.078c-0.37 2.354-2.745 6.901-9.078 6.901-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182c-2.786-2.599-6.396-4.182-10.719-4.182-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635 0-1.052-0.115-1.854-0.255-2.651z"></path>
            </svg>
          </button>
          <button aria-label="Log in with Twitter" className="p-3 rounded-sm bg-[#e5e7eb] hover:bg-[#d1d5db] transition-colors">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current text-[#1f2937]"
          ...
          <button aria-label="Log in with GitHub" className="p-3 rounded-sm bg-[#e5e7eb] hover:bg-[#d1d5db] transition-colors">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current text-[#1f2937]"
