    ...
    <section className="bg-white dark:bg-slate-900 rounded-xl border border-border shadow-sm overflow-hidden mb-8 transition-colors duration-300">
      ...
      <div className="p-8">
        <div className="relative space-y-12 before:absolute before:inset-0 before:ml-10 before:-translate-x-px before:h-full before:w-0.5 before:bg-gradient-to-b before:from-brand-600/50 before:via-brand-500/20 before:to-transparent">
            ...
            {fields.map((field, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-20 h-20 rounded-[2rem] bg-white dark:bg-slate-900 border-4 border-slate-50 dark:border-slate-800 shadow-xl flex items-center justify-center group-hover:bg-brand-600 group-hover:text-white transition-all duration-500 group-hover:scale-110 group-hover:rotate-6">
                ...
                {/* Content Card */}
                <div className="flex-1 bg-white dark:bg-slate-800/40 rounded-[2.5rem] border border-border p-8 transition-all duration-500 hover:border-brand-500/30 hover:shadow-2xl hover:shadow-brand-500/5 relative overflow-hidden">
                  ...
                  <div className="flex flex-col gap-8">
                    ...
                    {/* Timeline Data */}
                    <div className="bg-slate-50 dark:bg-slate-800/60 rounded-2xl p-6 border border-border">
                      <label className="text-[10px] font-semibold text-muted-foreground uppercase tracking-widest flex items-center gap-2 mb-4 pl-1">
                        <Calendar className="w-3 h-3" /> Employment Tenure
                      </label>
                    ...
                    <div className="space-y-3">
                      ...
                      <textarea
                        ...
                        className="w-full bg-slate-50 dark:bg-slate-800/20 border border-border rounded-2xl px-6 py-5 text-sm font-medium text-foreground placeholder:text-muted-foreground/20 italic focus:outline-none focus:ring-4 focus:ring-brand-500/10 focus:border-brand-500/50 focus:bg-white dark:focus:bg-slate-900 transition-all duration-300 resize-none leading-relaxed shadow-inner"
                      />
                    </div>
                  </div>
                </div>
          ...
          {fields.length === 0 && (
            <div className="text-center py-20 bg-slate-50/50 dark:bg-slate-800/10 border-2 border-dashed border-border rounded-[3rem] ml-20">
